...
#define SEM_UNMGK_MUTEX_QUEUE                                                  \
  "/image_unmagick_mutex_sem_queue" // mutex for senders if multiples, why not
                                    // multiples? :)
#define SEM_UNMGK_ITEMS_QUEUE                                                  \
  "/image_unmagick_items_sem_queue" // signals to workers
#define FIFO_ACK_UNMGCK_QUEUE "/tmp/unmgk_ack_fifo"

#define QUEUE_SIZE 10
#define MAX_IMAGE_BYTES (512 * 1024 * 1024) // 512MB

typedef enum { UNMGK_NEGATIVE, UNMGK_THRESHOLD, UNMGK_UNKNOWN_OP } unmgk_img_op;
